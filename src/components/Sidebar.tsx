                ...
                <div className="bg-[#180E35] border-e border-[#180E35] pt-7 pb-10 w-64 h-screen relative rounded-r-lg ">
                    ...
                    <div className="absolute z-50 bottom-8 border-t border-gray-100 border-opacity-20 pt-10 w-full items-center justify-center flex">
                        <div className="flex flex-col gap-7">
                            ...
                            <button onClick={()=>router.push("/")} className="rounded-full before:ease relative h-12 w-56 overflow-hidden border border-gray-500 bg-gray-500 bg-opacity-20 text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-gray-500 hover:before:-translate-x-40">
                                <div className="flex flex-row items-center px-5">
                                    <img width={23} src="/assets/icon/lock.svg" alt="add" />
                                    <div className="m-auto">
                                        <span className="relative z-10 font-semibold text-lg">Lock Wallet</span>
                                    </div>
                                </div>
                            </button>
