...
export default function PostSocialSuccess(){
    ...
    return(
        <div className="w-full min-h-screen bg-[#180E35] relative">
            ...
            <div className="flex p-5 items-center justify-center mt-[60px] flex-col gap-3">
                ...
                <span className="text-[#48bb78] font-semibold text-xl w-2/4 text-center text-wrap">You successfully posted on NEAR Social</span>
