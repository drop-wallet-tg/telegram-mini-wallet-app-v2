                ...
                <div className="p-5 mt-5 relative">
                    ...
                    <div className="flex flex-col gap-4 mt-8">
                        ...
                        <div  className="flex flex-row px-3 mt-2 items-center justify-between cursor-pointer text-white ">
                            <Link href="https://wallet.genadrop.xyz/support" className="flex flex-row gap-8 items-center hover:text-[#d6d6d6d2]">
                        ...
                        <div className="flex flex-row px-3 mt-2 items-center justify-between">
                            <Link href="https://wallet.genadrop.xyz/support" className="flex flex-row gap-8 items-center text-white hover:text-[#d6d6d6d2]">
